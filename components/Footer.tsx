...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background-dark text-slate-300 py-6 px-6 border-t border-slate-800">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-5">
        <div className="space-y-1.5">
          <h2 className="font-serif text-xl text-white font-light tracking-wide">글로리아 찬양대</h2>
          <p className="text-xs md:text-sm tracking-widest uppercase font-light text-slate-500">성남신광교회</p>
          <div className="flex items-center gap-4 text-sm md:text-base font-light text-slate-400 leading-none tracking-wide pt-1">
        ...
        <div className="flex flex-col md:items-end space-y-2">
          ...
          <div className="relative w-full md:w-64 h-16 bg-gray-900/50 rounded-sm overflow-hidden mt-2 border border-slate-800">
            <img 
      ...
      <div className="max-w-7xl mx-auto mt-4 pt-4 border-t border-slate-800/50 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-2">
